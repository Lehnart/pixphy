...
import com.setoh.pixphy.physics.system.PositionSpriteUpdater;
import com.setoh.pixphy.physics.system.PositionUpdater;
import com.setoh.pixphy.physics.system.TemporalPositionSpriteUpdater;
import com.setoh.pixphy.physics.system.VelocityUpdater;
...
public final class Game {
    ...
    public Game(int viewportWidth, int viewportHeight) {
        ...
        world.addComponent(asteroid, new PositionComponent(centerX - 15, centerY - 15));
        world.addComponent(asteroid, new VelocityComponent(0.,0.));
        world.addComponent(asteroid, new AccelerationComponent(10. ,0.));
        ...
        world.addSystem(new VelocityUpdater());
        world.addSystem(new PositionUpdater());
        world.addSystem(new PositionSpriteUpdater());
